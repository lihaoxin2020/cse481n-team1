...
def main():
    ...
    parser.add_argument("--ic_demo_path", default="./datasets/nq/orig_dev_filtered.json", type=str, help="Path to substituted demo file.")
    parser.add_argument("--ico_demo_path", default="./datasets/nq/orig_dev_filtered.json", type=str, help="Path to original demo file.")
